...
export function TopNav({ user }: { user: User }) {
  ...
  return (
    <header className="hidden md:flex items-center gap-6 px-6 h-14 border-b bg-background shrink-0">
      {/* Logo */}
      ...
      {/* Workspace switcher */}
      <DropdownMenu>
        <DropdownMenuTrigger className="flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent/50 transition-colors outline-none">
          <span>{wsIcon}</span>
