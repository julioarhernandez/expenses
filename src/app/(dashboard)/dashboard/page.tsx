  ...
  return (
    <div className="max-w-[1280px] mx-auto p-6 md:p-8 space-y-8 bg-[#FAFAFA] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-[#171717]">{workspace.name} {t('dashboard').title}</h1>
          <p className="text-neutral-500 font-medium">{format(now, 'MMMM yyyy', { locale })}</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-white border-neutral-200 shadow-[0_4px_20px_rgba(0,0,0,0.03)] rounded-xl hover:shadow-[0_10px_30px_rgba(0,0,0,0.06)] transition-all">
          ...
          <CardContent className="px-6 pb-6">
            ...
            <p className="text-xs text-neutral-500 mt-2 font-medium">{format(new Date(now.getFullYear(), now.getMonth() - 1, 1), 'MMMM', { locale })}</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white border-neutral-200 shadow-[0_4px_20px_rgba(0,0,0,0.03)] rounded-xl hover:shadow-[0_10px_30px_rgba(0,0,0,0.06)] transition-all">
          ...
          <CardContent className="px-6 pb-6">
            ...
            <p className="text-xs text-neutral-500 mt-2 font-medium">{lang === 'es' ? 'Ene' : 'Jan'} — {format(now, 'MMM', { locale })}</p>
          </CardContent>
        </Card>
